...
export const metadata: Metadata = {
  ...
  description:
    "Book a free 30-minute gap analysis. Global ISO 27001, ISO 42001, Cyber Essentials and GDPR consultancy serving every industry. Response within 1 working day.",
  openGraph: {
